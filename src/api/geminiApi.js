...
const API_KEY = process.env.REACT_APP_GEMINI_API_KEY; // Canvas provides this at runtime
const IMAGE_ANALYSIS_MODEL = "gemini-2.5-flash";
const API_URL = `https://generativelanguage.googleapis.com/v1/models/${IMAGE_ANALYSIS_MODEL}:generateContent?key=${API_KEY}`;
...
export const analyzeImageWithGemini = async (product, base64Data) => {
    ...
    {
    "productName": "${product}",
    "freshnessStatus": "Fresh | Stale | Rotten",
